...
import { createTailor, getTailor, updateTailor, deleteTailor, getAllAssignedMaterials,
  getDesignerPublicProfile, updateDesignerPortfolio, updatePortfolioItem, updatePortfolioItemVisibility,
  deletePortfolioItem,
...
router.put('/portfolio/items/:itemId', imageUpload, optionalImageKitUpload, updatePortfolioItem);
router.put('/portfolio/items/:itemId/visibility', updatePortfolioItemVisibility);
router.delete('/portfolio/items/:itemId', deletePortfolioItem);
